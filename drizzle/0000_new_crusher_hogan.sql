...
ALTER TABLE "issues" ADD CONSTRAINT "issues_column_id_columns_id_fk" FOREIGN KEY ("column_id") REFERENCES "public"."columns"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "column_project_idx" ON "columns" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX "issue_project_idx" ON "issues" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX "issue_column_idx" ON "issues" USING btree ("column_id");--> statement-breakpoint
CREATE INDEX "issue_assignee_idx" ON "issues" USING btree ("assignee_id");--> statement-breakpoint
